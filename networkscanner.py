...
def about():
		...
		print(colored("# Author      :", "green") + " Abdulaziz Ibrahim")
		print(colored("# Linkedin    :", "green") + " https://www.linkedin.com/abdulaziz-ibrahim0")
		print(colored("# Github      :", "green") + " https://github.com/jjj-abdulaziz")
		...
		print(colored("# Date        :", "green") + " 29.08.2025")
		print(colored("# Version     :", "green") + " 1.1")
		print(colored("# ==============================================================================\n", "green"))
